...
# users = User.create!([{ first_name: 'Иван', last_name: 'Тест', email: 'test_user@mail.ru', password: '121212', confirmed_at: Date.today },
#                       { first_name: 'Алиса', last_name: 'Тест', email: 'test_user2@mail.ru', password: 'qwerty', confirmed_at: Date.today }])
users = User.all
